...
public class ProductDAO {
        ...
        try {
            ...
            if (result != null) {
                while (result.next()) {
                    ...
                    monan.setPurcharsed(result.getInt("is_purcharsed"));
    ...
    public void xoa(ProductDTO monan) {
        try {
            ...
            qry = qry + " " + "where IDMonAn='" + monan.getProductId() + "'";
            connection.getStatement();
            connection.ExecuteUpdate(qry);
            connection.closeConnect();
        } catch (Exception e) {
    ...
    public void sua(ProductDTO monan) { //cần ghi lại khi qua class khác
        try {
            String qry = "Update productinstance Set ";
            qry = qry + "product_instance_id =" + "'" + monan.getCatalogueID() + "'";
            qry = qry + ",product_line_id=" + "'" + monan.getCatalogueID() + "'";
            qry = qry + ",is_purcharsed=" + "'" + monan.getPurcharsed() + "'";
