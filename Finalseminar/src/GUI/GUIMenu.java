...
public class GUIMenu extends JFrame{
    ...
    private String arr_listmenu[]={"Catalogue","Product"};
    ...
    //Tạo Panel cho bảng Product
    private JPanel pn_product=new JPanel();
    //Tạo Panel cho bảng Catalogue
    private JPanel pn_catalogue=new JPanel();
...
//        JPanel menu=new JPanel(new GridLayout(14, 1));
        ...
        JLabel logo=new JLabel(Tool.showIcon(width_menu, 200, "src/Images/Icon/rfid.png"));
        logo.setBounds(0, 0, width_menu, 200);
        //Sự kiện khi ấn vào logo thì hiện tên 
        logo.addMouseListener(new MouseAdapter(){
            @Override
            public void mousePressed(MouseEvent evt){
                title.setText("RFID DEMO");
            }
        });
        menu.add(logo);
...
//            if(timKiemMotQuyenTrongMoTaQuyen(moTaQuyen, arr_listmotaQuyen[i]))
    ...
    private JPanel content() throws Exception{
        ...
        for(int i=0;i<arr_listmenu.length;i++)
        {
            ...
            switch(i){
                case 0: 
                    GUICatalogue ca=new GUICatalogue();
                    pn_content[i]=ca;    break;                  
                case 1: 
                    GUIProduct pr=new GUIProduct();
                    pn_content[i]=pr; break;       
            }
    ...
    private JPanel header(){
        ...
        title=new JLabel("RFID Chainway C72");
